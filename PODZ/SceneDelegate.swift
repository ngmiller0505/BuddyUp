...
//        let googleDelegate = (UIApplication.shared.delegate as! AppDelegate).googleDelegate
        let currentUserWrapper = (UIApplication.shared.delegate as! AppDelegate).currentUserWrapper
        
        let contentView = ContentView().environmentObject(currentUserWrapper)
